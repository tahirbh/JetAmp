    ...
    <div className="grid grid-rows-[auto_1fr_auto] h-full w-full bg-gradient-to-b from-transparent to-[var(--bg-dark)]/40 relative overflow-hidden">
      <style>{`
        @media (orientation: landscape) and (max-height: 500px) {
          ...
          .landscape-full-height { height: 100% !important; margin-top: 0 !important; max-height: none !important; }
          .landscape-bottom-spectrum { display: block !important; opacity: 0.4; height: 30px !important; }
        }
      `}</style>
